export const RODEP_ABI = [
  ...
  { "inputs": [], "name": "DropMarketLibrary_General_Availability_Start_Time_Has_Expired", "type": "error" },
  ...
  { "inputs": [], "name": "MultiTokenDropMarketFixedPriceSale_Collection_Must_Be_ERC_1155", "type": "error" },
  {
  ...
  { "inputs": [], "name": "MultiTokenDropMarketFixedPriceSale_Must_Buy_At_Least_One_Token", "type": "error" },
  { "inputs": [], "name": "MultiTokenDropMarketFixedPriceSale_Must_Have_Available_Supply", "type": "error" },
  { "inputs": [], "name": "MultiTokenDropMarketFixedPriceSale_Payment_Address_Required", "type": "error" },
  { "inputs": [], "name": "MultiTokenDropMarketFixedPriceSale_Recipient_Cannot_Be_Zero_Address", "type": "error" },
  ...
  },
  {
    ...
    "inputs": [
      ...
      { "indexed": false, "internalType": "address payable", "name": "creatorPaymentAddress", "type": "address" },
      { "indexed": false, "internalType": "uint256", "name": "generalAvailabilityStartTime", "type": "uint256" }
    ],
