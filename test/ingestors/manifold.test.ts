...
describe('manifold', function () {
    basicIngestorTests(new ManifoldIngestor(), resources, {
        ...
        failureUrls: [
            ...
            'https://app.manifold.xyz/x/spaceexplorer/'
        ],
        successContracts: [
    ...
    it('createMintTemplateForUrl: Returns a mint template for a supported URL', async function () {
        ...
        expect(mintInstructions.contractParams).to.equal("[\"0xe2cf639a5eba5e8d1e291aeb44ac66c8c0727f98\", 22534384, 1, [], [], address]");
    ...
    it('createMintTemplateForContract: Returns a mint template for a supported contract', async function () {
        ...
        const contract = {
            chainId: 8453,
            contractAddress: '0xe2cf639a5eba5e8d1e291aeb44ac66c8c0727f98',
            url: 'https://app.manifold.xyz/c/spaceexplorer'
        };
